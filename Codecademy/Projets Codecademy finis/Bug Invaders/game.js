...
const defaultEnemyVelocity = .5;

const gameState = {
  enemyVelocity: defaultEnemyVelocity
};
...
function create() {
  ...
  gameState.enemyVelocity = defaultEnemyVelocity;
...
function update() {
    ...
    if(numOfTotalEnemies() === 0) {
      ...
      this.physics.pause();
      gameState.enemyVelocity = defaultEnemyVelocity;
      this.add.text(100, 482, 'You have won !', {fontSize: '15px', fill: '#000000'});
    } else {
